...
var OrderModalComponent = /** @class */ (function () {
    ...
    OrderModalComponent.prototype.ngAfterViewInit = function () {
    };
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], OrderModalComponent.prototype, "isAdmin", void 0);
    __decorate([
        core_1.ViewChild('orderForm'),
        __metadata("design:type", forms_1.NgForm)
    ], OrderModalComponent.prototype, "orderForm", void 0);
...
var OrdersComponent = /** @class */ (function () {
    ...
    OrdersComponent.prototype.ngOnInit = function () {
        ...
        this.isAdmin = false;
        var user = JSON.parse(localStorage.getItem('user'));
        var roles = user[user_key_1.roleKey];
        ...
        this.ordersService.getOrders().subscribe(function (resp) {
            ...
            if (Array.isArray(resp)) {
                resp.map(function (order, idx) {
                    _this.orders[idx].receiveOrderDate = order.receiveOrderDate ? new Date(order.receiveOrderDate) : null;
                    _this.orders[idx].etd = order.etd ? new Date(order.etd) : null;
                    _this.orders[idx].eta = order.eta ? new Date(order.eta) : null;
                });
            }
        });
        if (this.isAdmin) {
    ...
    OrdersComponent.prototype.onSaveChangeClick = function () {
        ...
        this.ordersService.saveOrder(this.order).subscribe(function (resp) {
            if (_this.order.id == null) {
                ...
                _this.orders[_this.currentOrderIdx] = _this.order;
            }
    ...
    OrdersComponent.prototype.onAddClick = function () {
        ...
        var user = JSON.parse(localStorage.getItem('user'));
        this.order.applicationUser_Id = this.isAdmin ? null : user[user_key_1.idKey];
    ...
    OrdersComponent.prototype.formateDate = function (date) {
        if (date) {
    ...
    __decorate([
        core_1.ViewChild(orderModal_component_1.OrderModalComponent),
        __metadata("design:type", orderModal_component_1.OrderModalComponent)
    ], OrdersComponent.prototype, "orderModal", void 0);
